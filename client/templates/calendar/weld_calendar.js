Template.weld_calendar_dallas.helpers({
  options: function() {
    return {
...
Template.weld_calendar_nashville.helpers({
  options: function() {
    return {
      googleCalendarApiKey: Meteor.settings.public.googleCalenderApiKey,
      eventSources: [
...
Template.weld_calendar_modal.events({
...
Template.weld_calendar_dallas.onRendered(function() {
  datepickerInit();
});

Template.weld_calendar_nashville.onRendered(function() {
  datepickerInit();
});
